...
<div style="padding-left:16px">
    <h2><u>FERTILIZER</u></h2>
        <button class='button button1' ><a href="add_fertilizer.php">ADD</button></a>
            <br><br>
          <table border="1">
             <tr>
                  <th>FID</th>
...
.button:hover {
  ...
  if($result){
      while($row=mysqli_fetch_assoc($result))
      {
        ...
        <td>
                <button class="button0"><a href="update_fertilizer.php?fid='.$FID.'">Update</a></button>
                <button class="button0"><a href="delete_fertilizer.php?fid='.$FID.'">Delete</a></button>
    </td>
    </tr>';
