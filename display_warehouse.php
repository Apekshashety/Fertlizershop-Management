...
<div style="padding-left:16px">
    <h2><u>WAREHOUSE</u></h2>
        <button  class='button button1' ><a href="add_warehouse.php">ADD</button></a>
            <br><br>
          <table border="1">
             <tr>
                  <th>WID</th>
                 <th>AVAILABLE STOCK(g)</th>
                 <th>SOLDOUT STOCK(g)</th>
                 <th>Delete</th>
            </tr>
            <style>
table {
  ...
  if($result){
      while($row=mysqli_fetch_assoc($result))
      {
        ...
        <td>
                ...
                <button class="button0 button2"><a href="delete_warehouse.php?wid='.$WID.'">Delete</a></button>
    </td>
    </tr>';
