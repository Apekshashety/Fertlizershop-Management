...
<div style="padding-left:16px">
    <h2><u>COMPANY PRODUCTS</u></h2>
        <button  class='button button1' ><a href="add_product.php">ADD</button></a>
            <br><br>
          <table >
             <tr>
                  <th>PID</th>
...
.button:hover {
  ...
  if($result){
      while($row=mysqli_fetch_assoc($result))
      {
        ...
        <td>
                <button class="button0" ><a href="update_product.php?pid='.$PID.'">Update</a></button>
                <button class="button0"><a href="delete_product.php?pid='.$PID.'">Delete</a></button>
    </td>
    </tr>';
